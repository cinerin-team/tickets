...
from misc.logic import collect_all_our_tickets_with_their_last_build_and_run_from_the_TREQ, \
    collect_the_tcs_which_will_todo_in_next_sprint, build_array_for_csv_from_tc_list, write_out_array_to_csv
...
if __name__ == '__main__':
    ...
    collected_TCs_main = collect_all_our_tickets_with_their_last_build_and_run_from_the_TREQ(parsed_array_main)
    todo_tickets_main = collect_the_tcs_which_will_todo_in_next_sprint(collected_TCs_main)
    ...
    if RELEASE_NEEDED:
        ...
        collected_TCs_release = collect_all_our_tickets_with_their_last_build_and_run_from_the_TREQ(parsed_array_release)
        todo_tickets_release = collect_the_tcs_which_will_todo_in_next_sprint(collected_TCs_release)
